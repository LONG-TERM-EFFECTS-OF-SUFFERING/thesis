...
| `max_videos_to_discover`  |    `INTEGER`    |             `PositiveIntegerField(null=True, blank=True)`             | YES  |  -  | Optional total number of videos the saved query should try to discover during later collection.        |
