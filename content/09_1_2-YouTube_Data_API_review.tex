...
\begin{table}[htbp]
    ...
    \begin{tabularx}
        {\textwidth}{>{\raggedright\arraybackslash}p{2.8cm}>{\raggedright\arraybackslash}p{3.2cm}X}
        \toprule
...
\begin{table}[htbp]
    ...
    \begin{tabularx}
        {\textwidth}{>{\raggedright\arraybackslash}p{2.6cm}>{\raggedright\arraybackslash}p{3.3cm}X}
        \toprule
...
\begin{table}[htbp]
    ...
    \begin{tabularx}
        {\textwidth}{>{\raggedright\arraybackslash}p{3.3cm}>{\raggedright\arraybackslash}p{2.2cm}X}
        \toprule
